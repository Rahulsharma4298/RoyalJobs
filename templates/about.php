  ...
  <div class="container py-5">
    <div class="row h-100 align-items-center py-5">
      <div class="col-lg-6">
        ...
        <p class="lead text-muted mb-0">Apply for Jobs and Get Hired!</p>
        <p class="lead text-muted">Recruiters can Post Jobs <a href="#" class="text-muted"> 
                    <u>Click Here</u></a>
        </p>
      </div>
  ...
  <div class="container py-5">
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
        <h2 class="font-weight-light">Apply for Jobs & Internships</h2>
        <p class="font-italic text-muted mb-4">Users Can Apply for Jobs & Internships with ease.</p><a href="#" class="btn btn-primary px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
        <h2 class="font-weight-light">Recruit With Us</h2>
        <p class="font-italic text-muted mb-4">Recruiters Can List the Jobs & Internships.</p><a href="#" class="btn btn-primary px-5 rounded-pill shadow-sm">Learn More</a>
      </div>
    </div>
  </div>
</div>
...
<div class="bg-light py-5">
  <div class="container py-5">
    <div class="row mb-4">
      <div class="col-lg-5">
        <h3 class="display-4 font-weight-light">Our team</h3>
        <p class="font-italic text-muted">Our Team, Our Value.</p>
      </div>
    </div>
    ...
    <div class="row text-center">
      ...
      <div class="col-xl-3 col-sm-6 mb-5">
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="https://res.cloudinary.com/mhmd/image/upload/v1556834132/avatar-4_ozhrib.png" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          <h5 class="mb-0">Rahul Sharma</h5><span class="small text-uppercase text-muted">CEO - Founder</span>
